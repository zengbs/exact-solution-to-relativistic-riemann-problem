...
void Plot(int Pattern, struct RiemannProblem *RP, struct PlotParams plot) {
  ...
  if (Pattern == 1) {
    fprintf(fptr[0], "%20.16e %20.16e %20.16e %20.16e\n", X_Left,
            RP->SS.Leftt.DensUpStream, RP->SS.Leftt.VelyUpStream,
    ...
    fprintf(fptr[0], "%20.16e %20.16e %20.16e %20.16e\n", X0,
            RP->SS.Right.DensUpStream, RP->SS.Right.VelyUpStream,
    ...
    fprintf(fptr[0], "%20.16e %20.16e %20.16e %20.16e\n", X_Left,
            RP->RS.Leftt.DensUpStream, RP->RS.Leftt.VelyUpStream,
    ...
    fprintf(fptr[0], "%20.16e %20.16e %20.16e %20.16e\n", X0,
            RP->RS.Right.DensUpStream, RP->RS.Right.VelyUpStream,
            RP->RS.Right.PresUpStream);
    fprintf(fptr[0], "%20.16e %20.16e %20.16e %20.16e\n", X_Right,
            RP->RS.Right.DensUpStream, RP->RS.Right.VelyUpStream,
            RP->RS.Right.PresUpStream);
  } else if (Pattern == 3) {
    fprintf(fptr[0], "%20.16e %20.16e %20.16e %20.16e\n", X_Left,
            RP->SR.Leftt.DensUpStream, RP->SR.Leftt.VelyUpStream,
            RP->SR.Leftt.PresUpStream);
    fprintf(fptr[0], "%20.16e %20.16e %20.16e %20.16e\n", X0 - dX,
            RP->SR.Leftt.DensUpStream, RP->SR.Leftt.VelyUpStream,
            RP->SR.Leftt.PresUpStream);

    fprintf(fptr[0], "%20.16e %20.16e %20.16e %20.16e\n", X0,
            RP->SR.Right.DensUpStream, RP->SR.Right.VelyUpStream,
            RP->SR.Right.PresUpStream);
    fprintf(fptr[0], "%20.16e %20.16e %20.16e %20.16e\n", X_Right,
            RP->SR.Right.DensUpStream, RP->SR.Right.VelyUpStream,
            RP->SR.Right.PresUpStream);
  } else if (Pattern == 4) {
    fprintf(fptr[0], "%20.16e %20.16e %20.16e %20.16e\n", X_Left,
            RP->RR.Leftt.DensUpStream, RP->RR.Leftt.VelyUpStream,
            RP->RR.Leftt.PresUpStream);
    fprintf(fptr[0], "%20.16e %20.16e %20.16e %20.16e\n", X0 - dX,
            RP->RR.Leftt.DensUpStream, RP->RR.Leftt.VelyUpStream,
            RP->RR.Leftt.PresUpStream);

    fprintf(fptr[0], "%20.16e %20.16e %20.16e %20.16e\n", X0,
            RP->RR.Right.DensUpStream, RP->RR.Right.VelyUpStream,
            RP->RR.Right.PresUpStream);
    fprintf(fptr[0], "%20.16e %20.16e %20.16e %20.16e\n", X_Right,
            RP->RR.Right.DensUpStream, RP->RR.Right.VelyUpStream,
            RP->RR.Right.PresUpStream);
  }
      ...
      switch (region) {
        case 1:
          if (Pattern == 1) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->SS.Leftt.DensUpStream, RP->SS.Leftt.VelyUpStream,
                    RP->SS.Leftt.PresUpStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->SS.Leftt.DensUpStream, RP->SS.Leftt.VelyUpStream,
                    RP->SS.Leftt.PresUpStream, region);
          } else if (Pattern == 2) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->RS.Leftt.DensUpStream, RP->RS.Leftt.VelyUpStream,
                    RP->RS.Leftt.PresUpStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->RS.Leftt.DensUpStream, RP->RS.Leftt.VelyUpStream,
                    RP->RS.Leftt.PresUpStream, region);
          } else if (Pattern == 3) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->SR.Leftt.DensUpStream, RP->SR.Leftt.VelyUpStream,
                    RP->SR.Leftt.PresUpStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->SR.Leftt.DensUpStream, RP->SR.Leftt.VelyUpStream,
                    RP->SR.Leftt.PresUpStream, region);
          } else if (Pattern == 4) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->RR.Leftt.DensUpStream, RP->RR.Leftt.VelyUpStream,
                    RP->RR.Leftt.PresUpStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->RR.Leftt.DensUpStream, RP->RR.Leftt.VelyUpStream,
                    RP->RR.Leftt.PresUpStream, region);
          }
        ...
        case 2:
          if (Pattern == 2) {
            ...
            do {
              ...
              PresFan = GetPresInFan(DensFan, RP->RS.Leftt.PresUpStream,
                                     RP->RS.Leftt.DensUpStream);
              VelocityFan = GetVelocityInFan(RP->RS.Leftt.Xi, DensFan, PresFan,
                                             RP->RS.Leftt.Right_Yes);

              fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n",
                      RP->RS.Leftt.Xi * time + X0, DensFan, VelocityFan,
                      PresFan, region);
            ...
            do {
              ...
              PresFan = GetPresInFan(DensFan, RP->RR.Leftt.PresUpStream,
                                     RP->RR.Leftt.DensUpStream);
              VelocityFan = GetVelocityInFan(RP->RR.Leftt.Xi, DensFan, PresFan,
                                             RP->RR.Leftt.Right_Yes);

              fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n",
                      RP->RR.Leftt.Xi * time + X0, DensFan, VelocityFan,
                      PresFan, region);
        ...
        case 3:
          if (Pattern == 1) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->SS.Leftt.DensDownStream, RP->SS.Leftt.VelyDownStream,
                    RP->SS.Leftt.PresDownStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->SS.Leftt.DensDownStream, RP->SS.Leftt.VelyDownStream,
                    RP->SS.Leftt.PresDownStream, region);
          } else if (Pattern == 2) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->RS.Leftt.DensDownStream, RP->RS.Leftt.VelyDownStream,
                    RP->RS.Leftt.PresDownStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->RS.Leftt.DensDownStream, RP->RS.Leftt.VelyDownStream,
                    RP->RS.Leftt.PresDownStream, region);
          } else if (Pattern == 3) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->SR.Leftt.DensDownStream, RP->SR.Leftt.VelyDownStream,
                    RP->SR.Leftt.PresDownStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->SR.Leftt.DensDownStream, RP->SR.Leftt.VelyDownStream,
                    RP->SR.Leftt.PresDownStream, region);
          } else if (Pattern == 4) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->RR.Leftt.DensDownStream, RP->RR.Leftt.VelyDownStream,
                    RP->RR.Leftt.PresDownStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->RR.Leftt.DensDownStream, RP->RR.Leftt.VelyDownStream,
                    RP->RR.Leftt.PresDownStream, region);
          }
        ...
        case 4:
          if (Pattern == 1) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->SS.Right.DensDownStream, RP->SS.Right.VelyDownStream,
                    RP->SS.Right.PresDownStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->SS.Right.DensDownStream, RP->SS.Right.VelyDownStream,
                    RP->SS.Right.PresDownStream, region);
          } else if (Pattern == 2) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->RS.Right.DensDownStream, RP->RS.Right.VelyDownStream,
                    RP->RS.Right.PresDownStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->RS.Right.DensDownStream, RP->RS.Right.VelyDownStream,
                    RP->RS.Right.PresDownStream, region);
          } else if (Pattern == 3) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->SR.Right.DensDownStream, RP->SR.Right.VelyDownStream,
                    RP->SR.Right.PresDownStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->SR.Right.DensDownStream, RP->SR.Right.VelyDownStream,
                    RP->SR.Right.PresDownStream, region);
          } else if (Pattern == 4) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->RR.Right.DensDownStream, RP->RR.Right.VelyDownStream,
                    RP->RR.Right.PresDownStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->RR.Right.DensDownStream, RP->RR.Right.VelyDownStream,
                    RP->RR.Right.PresDownStream, region);
          }
        ...
        case 5:
          if (Pattern == 3) {
            ...
            do {
              ...
              PresFan = GetPresInFan(DensFan, RP->SR.Right.PresUpStream,
                                     RP->SR.Right.DensUpStream);
              VelocityFan = GetVelocityInFan(RP->SR.Right.Xi, DensFan, PresFan,
                                             RP->SR.Right.Right_Yes);

              fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n",
                      RP->SR.Right.Xi * time + X0, DensFan, VelocityFan,
                      PresFan, region);
            ...
            do {
              ...
              PresFan = GetPresInFan(DensFan, RP->RR.Right.PresUpStream,
                                     RP->RR.Right.DensUpStream);
              VelocityFan = GetVelocityInFan(RP->RR.Right.Xi, DensFan, PresFan,
                                             RP->RR.Right.Right_Yes);

              fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n",
                      RP->RR.Right.Xi * time + X0, DensFan, VelocityFan,
                      PresFan, region);
        ...
        case 6:
          if (Pattern == 1) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->SS.Right.DensUpStream, RP->SS.Right.VelyUpStream,
                    RP->SS.Right.PresUpStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->SS.Right.DensUpStream, RP->SS.Right.VelyUpStream,
                    RP->SS.Right.PresUpStream, region);
          } else if (Pattern == 2) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->RS.Right.DensUpStream, RP->RS.Right.VelyUpStream,
                    RP->RS.Right.PresUpStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->RS.Right.DensUpStream, RP->RS.Right.VelyUpStream,
                    RP->RS.Right.PresUpStream, region);
          } else if (Pattern == 3) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->SR.Right.DensUpStream, RP->SR.Right.VelyUpStream,
                    RP->SR.Right.PresUpStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->SR.Right.DensUpStream, RP->SR.Right.VelyUpStream,
                    RP->SR.Right.PresUpStream, region);
          } else if (Pattern == 4) {
            ...
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Min,
                    RP->RR.Right.DensUpStream, RP->RR.Right.VelyUpStream,
                    RP->RR.Right.PresUpStream, region);
            fprintf(fptr[j], "%20.16e %20.16e %20.16e %20.16e %d\n", X_Max,
                    RP->RR.Right.DensUpStream, RP->RR.Right.VelyUpStream,
                    RP->RR.Right.PresUpStream, region);
          }
